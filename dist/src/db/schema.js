...
export const ACCOUNT_STATUSES = ["active", "inactive", "on_hold"];
export const ACCOUNT_TYPES = ["client", "client_vendor", "vendor", "prospect"];
...
export const EMPLOYEE_STATUSES = ["active", "offboarded", "on_bench"];
export const EMPLOYMENT_TYPES = ["full_time", "contractor", "part_time", "intern"];
...
export const CAMPAIGN_TYPES = ["hotlist", "job_campaign"];
